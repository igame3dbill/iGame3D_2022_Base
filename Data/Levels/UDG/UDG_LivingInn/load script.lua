...
loadMesh("Data/Levels/UDG/UDG_LivingInn/UDG_LivingInn_level_mesh.wtf")
...
-- auto camera move 
--[[
		udg_handle_camera=move_camera_to_poncho_co_building
