...
function zfps_multifollowerLight(x,y,z)
...
setLightInfo(1, IG3D_CONSTANT_ATTENUATION, 1.000000)
	...
	function zfps_LivingInnFiveLight()
...
function zfps_test_light_tint_fog()
...
function BombLightFive(x,y,z)
setLightInfo(5, IG3D_ENABLED, true)
setLightInfo(5, IG3D_POSITION, x,y+2,z)
setLightInfo(5, IG3D_AMBIENT, 1.000000,1.000000,1.000000,1.000000)
setLightInfo(5, IG3D_DIFFUSE, 1.000000,1.000000,0.308000,1.000000)
setLightInfo(5, IG3D_SPECULAR, 1.000000,1.000000,1.000000,1.000000)
setLightInfo(5, IG3D_CONSTANT_ATTENUATION, 0.000000)
setLightInfo(5, IG3D_LINEAR_ATTENUATION, 0.000000)
setLightInfo(5, IG3D_QUADRATIC_ATTENUATION, 0.000000)
setLightInfo(5, IG3D_SPOTLIGHT, 0.000000,-0.020000,0.000000,179.860001,0.000000)
gBombLightCount=0
end
...
function PlayerLightSeven(x,y,z)
setLightInfo(7, IG3D_ENABLED, true)
setLightInfo(7, IG3D_POSITION, x,y+1,z)
setLightInfo(7, IG3D_AMBIENT, 1.000000,1.000000,1.000000,1.000000)
setLightInfo(7, IG3D_DIFFUSE, 1.000000,1.000000,0.308000,1.000000)
setLightInfo(7, IG3D_SPECULAR, 1.000000,1.000000,1.000000,1.000000)
setLightInfo(7, IG3D_CONSTANT_ATTENUATION, 0.100000)
setLightInfo(7, IG3D_LINEAR_ATTENUATION, 0.004000)
setLightInfo(7, IG3D_QUADRATIC_ATTENUATION, 0.040000)
setLightInfo(7, IG3D_SPOTLIGHT, 0.000000,-0.020000,0.000000,179.860001,0.000000)
gPlayerLightCount=0
end

function zfps_ScreamLight(obj)
...
function zfps_snipersalleylights()
setSceneInfo(IG3D_TINT_COLOR, 0.800000,0.800000,1.000000)
...
function zfps_Instructions_lightfive()
setSceneInfo(IG3D_TINT_COLOR, 0.300000,0.300000,0.600000)
...
if gScreamer ~= nil then 
	...
	if getLightInfo(5, IG3D_ENABLED) == true then
	gBombLightCount = gBombLightCount + passed()
	local brightness=1.0-gBombLightCount/0.7
	setLightInfo(5, IG3D_AMBIENT, brightness, brightness, brightness,1.000000)
	setLightInfo(5, IG3D_DIFFUSE, brightness, brightness, brightness*0.308000,1.000000)
	setLightInfo(5, IG3D_SPECULAR, brightness, brightness, brightness,1.000000)
	end
	
	if gBombLightCount > 0.8 then 
		gBombLightCount = 0 
		setLightInfo(5, IG3D_ENABLED, false)
	end
	

if getLightInfo(7, IG3D_ENABLED) == true then
	gPlayerLightCount = gPlayerLightCount + passed()
	local brightness=1.0-gPlayerLightCount/0.3
	setLightInfo(7, IG3D_AMBIENT, brightness, brightness, brightness,1.000000)
	setLightInfo(7, IG3D_DIFFUSE, brightness, brightness, brightness*0.308000,1.000000)
	setLightInfo(7, IG3D_SPECULAR, brightness, brightness, brightness,1.000000)
	end

if gPlayerLightCount > 0.3 then 
		gPlayerLightCount = 0 
		setLightInfo(7, IG3D_ENABLED, false)
	end
