...
function zfps_handle_zombie_idle_sounds()
	local i
...
function zfps_update_object_sounds()
	for i=1,#gObjects,1 do
		...
		zfps_play_footsteps_sound(gObjects[i])
	end
end

function zfps_set_gender_specific_pitch(obj)
...
function play_scared_sound(obj)
...
function play_get_eaten_sound(obj)
	setSound_emitterInfo(obj.voiceSndEmt, IG3D_STOP)
	setSound_emitterInfo(obj.voiceSndEmt, IG3D_LOOP,false)
	setSound_emitterInfo(obj.voiceSndEmt, IG3D_PITCH, 100)
	setSound_emitterInfo(obj.voiceSndEmt, IG3D_POSITION, getObjectInfo(obj.cObj, IG3D_POSITION))
...
function play_hit_sound_solid(obj)
	obj.nextSoundTime=time()+0.5
	setSound_emitterInfo(obj.noiseSndEmt, IG3D_STOP)
	setSound_emitterInfo(obj.noiseSndEmt, IG3D_PITCH, 100)
	setSound_emitterInfo(obj.noiseSndEmt, IG3D_POSITION, getObjectInfo(obj.cObj, IG3D_POSITION))
...
function play_glass_break_sound(obj)
	obj.nextSoundTime=time()+0.5
	setSound_emitterInfo(obj.noiseSndEmt, IG3D_STOP)
	setSound_emitterInfo(obj.noiseSndEmt, IG3D_PITCH, 100)
	setSound_emitterInfo(obj.noiseSndEmt, IG3D_POSITION, getObjectInfo(obj.cObj, IG3D_POSITION))
...
function zfps_play_zombie_acknowledge_sound(obj)
	obj.nextSoundTime=time()+0.5
	setSound_emitterInfo(obj.voiceSndEmt, IG3D_STOP)
	zfps_set_gender_specific_pitch(obj)
	--setSound_emitterInfo(obj.voiceSndEmt, IG3D_POSITION, getObjectInfo(obj.cObj, IG3D_POSITION))
...
function zfps_play_zombie_impossible_sound(obj)
	obj.nextSoundTime=time()+0.5
...
gZombieIdleSamples={"Data/Sounds/male_eaten.ogg"}
function play_zombie_idle_sound(obj)
...
function zfps_play_footsteps_sound(obj)
...
function zfps_all_sounds_stop()
	...
	if gZFPSMusicAction then setSound_emitterInfo(gZFPSMusicAction, IG3D_STOP) end
end
