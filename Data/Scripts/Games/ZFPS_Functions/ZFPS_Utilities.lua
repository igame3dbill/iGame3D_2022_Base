function zfps_place_objects_randomly()
...
function zfps_create_safe_places_randomly()
		gSafePlaces={}
...
local levelslist=""
	...
	listedFiles=listFiles(zfpsPath ..v)
		...
		if vv ~= nil then 
			...
			local levelshortname = string.sub(v,string.find(v,"ZFPS_")+5,-1)
			table.insert(ZFPS_LevelsTable,{"ZFPS/"..v, levelshortname})
