...
gZFPS_PickedLevel = "Data/Levels/ZFPS/ZFPS_MainMenu"
-- zfps_listLevels

ZFPS_LevelsTable={}
ZFPS_EasyLevelsTable={}
ZFPS_ChallengeLevelsTable={}
ZFPS_HardLevelsTable={}

function zfps_listLevels()
ZFPS_LevelsTable={}
ZFPS_EasyLevelsTable={}
ZFPS_ChallengeLevelsTable={}
ZFPS_HardLevelsTable={}
...
function trigger_load_living_inn()
	loadLevel("Data/Levels/ZFPS/ZFPS_LivingInn")
end
...
function trigger_load_level_i()
	...
	gZFPSMusic=nil
	gZFPSMusicAction=nil
	loadLevel("Data/Levels/ZFPS/ZFPS_"..gButtonNames[gOldSelectedMenuButton])
end
...
--build the levels list
 ...
 for i=1,#ZFPS_EasyLevelsTable,1 do
 	table.insert(gButtonNames, string.sub(ZFPS_EasyLevelsTable[i][1], 9,-1))
  ...
  for i=1,#ZFPS_ChallengeLevelsTable,1 do
 	table.insert(gButtonNames, string.sub(ZFPS_ChallengeLevelsTable[i][1], 9, -1))
 	make(ig3d_text_box, "Data/FontPngs/CRAMPS32_1.png")
 	table.insert(gMenuButtonsText, #gMenuButtonsText+1)
 	setText_boxInfo(#gMenuButtonsText, IG3D_FONT, "Data/FontPngs/CRAMPS32_1.png")
 	table.insert(gButtonTriggerFunctionsText, trigger_load_level_i)
...
function zfps_mouse_and_buttons_text()
	...
	for i=1,#gButtonNames,1 do
		if ("Data/Levels/ZFPS/ZFPS_"..gButtonNames[i])==gCurrentLevel then setText_boxInfo(i, IG3D_COLOR, 0,1,0,1) end
	end
