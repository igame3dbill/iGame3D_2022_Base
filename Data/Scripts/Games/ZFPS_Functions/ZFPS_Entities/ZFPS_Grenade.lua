...
function throw_grenade(x,y,z, dx,dy,dz)
...
function get_nearest_grenade_to_position(x,y,z)
	local dst=-1
	local i
	local nearest=-1
...
function zfps_explode_nearest_grenade_to_position(x,y,z)
	local nearest= get_nearest_grenade_to_position(x,y,z)
	if nearest>0 then
