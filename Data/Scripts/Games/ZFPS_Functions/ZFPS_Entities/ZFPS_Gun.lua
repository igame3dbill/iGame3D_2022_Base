...
gPlayerGuns={}
playerMachineGun={interval=0.08, ammo=42, ammoFull=42}
playerPistol={interval=0.2, ammo=16, ammoFull=16}
table.insert(gPlayerGuns, playerPistol)
table.insert(gPlayerGuns, playerMachineGun)
gCurPlayerGun=1
