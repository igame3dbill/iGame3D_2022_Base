...
for i=1,#gObjects,1 do
	...
	if checkName=="zomb" or string.find(checkName,"zombie") ~=nil or string.find(sourceWTF,"slimed") or string.find(sourceWTF,"snowed")  then
--print(getObjectInfo(gObjects[i].cObj, IG3D_NAME))
		...
		setSound_emitterInfo(gObjects[i].voiceSndEmt, IG3D_VOLUME, 3)
