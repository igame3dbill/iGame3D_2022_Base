...
setObjectInfo(selected_object, IG3D_HUD, false)
end
...
function face_followObject(objN,target)
	facer=gObjects[objN].cObj
	faceObj(facer,target)
 ...
 setObjectInfo(facer, IG3D_FORCE, a31*4,a32*1,a33*4) 
setObjectInfo(facer, IG3D_VECTOR_CONSTRAINT, 0,1,0)
end
