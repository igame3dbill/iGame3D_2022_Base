...
function createLocalMatricesForBVHFrame(bone, itrtr)
	...
	a11,a12,a13,a14, a21,a22,a23,a24, a31,a32,a33,a34, a41,a42,a43,a44 = loadIdentityMatrix()
	...
	if key("t","-") then
		...
		if bone.name=="lShldr" then
			setObjectInfo(bvhmarker, IG3D_POSITION, 0,0,0)
			setObjectInfo(bvhmarker, IG3D_ROTATION, 0,180,90)
			a11,a12,a13,a14, a21,a22,a23,a24, a31,a32,a33,a34, a41,a42,a43,a44=getObjectInfo(bvhmarker, IG3D_ROTATION_MATRIX)
			y11,y12,y13,y14, y21,y22,y23,y24, y31,y32,y33,y34, y41,y42,y43,y44=matrixConcat(y11,y12,y13,y14, y21,y22,y23,y24, y31,y32,y33,y34, y41,y42,y43,y44, a11,a12,a13,a14, a21,a22,a23,a24, a31,a32,a33,a34, a41,a42,a43,a44)
		end
	
		if bone.name=="rShldr" then
			setObjectInfo(bvhmarker, IG3D_POSITION, 0,0,0)
			setObjectInfo(bvhmarker, IG3D_ROTATION, 0,180,-90)
			a11,a12,a13,a14, a21,a22,a23,a24, a31,a32,a33,a34, a41,a42,a43,a44=getObjectInfo(bvhmarker, IG3D_ROTATION_MATRIX)
			y11,y12,y13,y14, y21,y22,y23,y24, y31,y32,y33,y34, y41,y42,y43,y44=matrixConcat(y11,y12,y13,y14, y21,y22,y23,y24, y31,y32,y33,y34, y41,y42,y43,y44, a11,a12,a13,a14, a21,a22,a23,a24, a31,a32,a33,a34, a41,a42,a43,a44)
...
function loadBVHFile(fileName, generateSkeletonWTF)
	...
	neutralPose(rootBone)--undangerous even if bvhmarker is not the correct model yet
	
	calculatePoseFromLocalMatrices(rootBone)
	
	if generateSkeletonWTF == true then
		createMeshBones(rootBone)
		saveMesh("Data/WTF/Characters/truebonesbvh.wtf")
	end
	
	delete(ig3d_object, bvhmarker)
	bvhmarker=make(ig3d_object, "Characters/truebonesmaster.wtf")
	--bvhmarker=make(ig3d_object, "Characters/ponchocorpgirl.wtf")
	setObjectInfo(bvhmarker, IG3D_NAME, "truebonesmaster1")
	--bvhmarker=make(ig3d_object, "Characters/truebonesbvh.wtf")
	
	neutralPose(rootBone)
	
	if gBoneStart~= 20 then
		fltk.fl_message("This BVH file has a different bone set than the model you are using it at, this will look ugly, man!")
	end
