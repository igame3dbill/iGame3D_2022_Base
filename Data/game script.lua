--igame3d game script lua 02 2013
...
--[[
Now a quick hack for the iPhone / iPod Touch:
If murgaLua is not there, we assume that we are running iGame3D on a deployment-only device such as the iPhone or iPod Touch!
In that case start another level and skip all the other stuff
--]]
if not murgaLua then
	gameroot=bundleroot
