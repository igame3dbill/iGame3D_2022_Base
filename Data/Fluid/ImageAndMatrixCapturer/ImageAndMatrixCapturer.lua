...
capturer:resize(768,265,502,252)
--capturer:show()
...
capture_button:resize(5,95,195,25)
...
create_button:resize(5,135,100,25)
--unknown attribute: deactivate
end
...
points_button:resize(5,60,195,25)
points_button:type(1)
end
...
weiter_button:resize(375,60,85,25)
end
...
fertig_button:resize(365,135,100,25)
--unknown attribute: deactivate
end
...
autoflightButton:resize(320,100,145,25)
...
speedControl:resize(275,135,85,25)
...
crosshairFlag:resize(205,100,100,25)
crosshairFlag:down_box(fltk.FL_DOWN_BOX)
end

do savescene= fltk:Fl_Button(0,0,0,0,"")
if gLabelTable==nil then gLabelTable={} end
table.insert(gLabelTable, "Szene abspeichern")
savescene:label(gLabelTable[#gLabelTable])
savescene:callback(savesceneClicked)
savescene:resize(205,5,135,25)
end

do loadscene= fltk:Fl_Button(0,0,0,0,"")
if gLabelTable==nil then gLabelTable={} end
table.insert(gLabelTable, "Szene laden")
loadscene:label(gLabelTable[#gLabelTable])
loadscene:callback(loadsceneClicked)
loadscene:resize(340,5,135,25)
end
end
capturer:show()
