...
-- RNDRTS template load Script loadMesh in [1]

RNDRTSLoadScript={}
RNDRTSLoadScript[1]='loadMesh("Data/WTF/Locations/streetMap384x384A.wtf")\n'
...
do RNDRTS_Maker= fltk:Fl_Double_Window(0,0,0,0,"")
if gLabelTable==nil then gLabelTable={} end
table.insert(gLabelTable, "RNDRTS_Maker")
RNDRTS_Maker:label(gLabelTable[#gLabelTable])
RNDRTS_Maker:resize(632,50,186,164)
RNDRTS_Maker:when(6)
--RNDRTS_Maker:show()
